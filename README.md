...
サーバーサイドエンジニアとして[スマートフォンアプリ](https://keyakise.jp)のビジネスロジックの開発を担当しています。使用している言語はGoです。
...
ゲームの開発プロセスの中で自動化できそうな部分が手動で設計されていたり、カスタマーサポートのプロセスに非効率な部分があると感じていたため、自動化のためにMachine Learningの手法を検討しました。いくつかプロトタイプ([1](https://blog.codingecho.com/2018/01/01/gan-ios-app/), [2](https://blog.codingecho.com/2018/03/25/lstmを使ってテキストの他クラス分類をする/))を作成して社内に向けて説明することで、Machine Learningを使った自動化の有用性を社内に示すことができました。その結果として、Machine Learningを使ったカスタマーサポートの自動返答の設計開発を担当させてもらえることになりました。
